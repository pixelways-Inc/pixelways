...
const CaseStudySlugPage = () => {
  const caseStudy = {
    ...
    imageUrl: "https://api.a0.dev/assets/image?text=Mannor+Janitorial+Enterprise+Cleaning+Solutions&aspect=16:9&seed=456", // Assuming image is directly in public folder
                    ...
                    <div className="case-info-item">
                      ...
                      <div className="content">
                        <div className="category">
                          <Link href="/cases/cleaning-solutions">Cleaning Solutions</Link>,
                          <Link href="/cases/facility-management">Facility Management</Link>
                        </div>
                      </div>
                    </div>
                    <div className="case-info-item">
