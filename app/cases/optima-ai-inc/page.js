...
const CaseStudySlugPage = () => {
  const caseStudy = {
    ...
    objective: `To make Artificial Intelligence (AI) radically accessible, private, and empowering for businesses. As a solo founder company under Pixelways Solution Inc., Optima AI aims to transform operations and foster innovation by providing cutting-edge AI solutions that are easy to integrate and respect user privacy.`,
