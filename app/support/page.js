...
const SupportPage = () => {
  return (
    <TekprofLayout>
      ...
      <section className="support-area py-130 rpy-100">
            ...
            <div className="col-lg-12">
              <div className="support-content">
                ...
                <ul className="list-style-one mt-4">
                  <li><strong>Email:</strong> <a href="mailto:[Your Support Email]">[Your Support Email]</a></li>
                  <li><strong>Phone:</strong> <a href="tel:[Your Support Phone]">[Your Support Phone]</a></li>
